...
EXPERIMENTAL_TREATMENTS = {
    ...
    'validation_prios0.5': [{'topic_class_data_sizes': dsizes[0],
                    ...
                    'num_net_flows': 9,
                    'algorithm': dict(algorithm='greedy', ro_tolerance=0.4),
                    'num_topics': 200,
                    'num_iots': 150,
                    'num_ffs': 9,
                    'topic_class_advertisements_per_ff': (3, 5),
                    'topic_class_advertisements_per_iot': (5, 4),
                    'topic_class_sub_rates': (0.15, 0.25),
    ...
    'validation_prios0.9': [{'topic_class_data_sizes': dsizes[0],
                    ...
                    'num_priority_levels': 9,
                    'num_net_flows': 9,
                    'algorithm': dict(algorithm='greedy', ro_tolerance=0.05),
                    'num_topics': 200,
                    'num_iots': 150,
                    'num_ffs': 9,
                    'topic_class_advertisements_per_ff': (3, 5),
                    'topic_class_advertisements_per_iot': (5, 4),
                    'topic_class_sub_rates': (0.30, 0.4),
                    # we multiple bw 8 with num of FFs
                    'bandwidth': 80,
                    'testing': False,
                    # 'testing': True,
    ...
    # 'data_sizes': [{'topic_class_data_sizes': dsizes[0],
    #                 'nruns': 1,
    #                 'topic_class_pub_rates': prates,
    #                 'num_priority_levels': 9,
    #                 'num_net_flows': 9,
